...
try {
         const configuration = new Configuration({
          ...
          //console.log(err);
          m.reply("Uppsss... erorr\ncek kembali apikey openai kamu di config.json\n\nBeberapa tempat run juga tidak support openai")
...
${isSurender ? '' : ``}`.trim()
         haruka.sendTextWithMentions(m.chat, caption, m)
            .then(mes => {
      ...
      if (tebakgambar[m.chat] && !isCmd && m.quoted) {
         if (m.quoted.id == tebakgambar[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              ...
              await haruka.sendButtonText(m.chat, [{
         ...
         if (m.quoted.id == tebakkata[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              await addBalance(m.sender, tebakkata[m.chat][2], balance)
               ...
               reply(`_Njir betul, ketik .tebakkata untuk bermain lagi_`)
         ...
         if (m.quoted.id == tebakbendera[m.chat][0].key.id) {
            ...
            await addBalance(m.sender, tebakbendera[m.chat][2], balance) 
              await haruka.sendButtonText(m.chat, [{
               ...
               reply(`_Njir betul, ketik .tebakbendera untuk bermain lagi_`)              
         ...
         if (m.quoted.id == caklontong[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              ...
              await haruka.sendButtonText(m.chat, [{
               ...
               reply(`_Njir betul, ketik .caklontong bermain lagi_`)
         ...
         if (m.quoted.id == susunkata[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              ...
              await haruka.sendButtonText(m.chat, [{
               ...
               reply(`_Njir betul, ketik .susunkata untuk bermain lagi_`)
         ...
         if (m.quoted.id == tebakkalimat[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              await addBalance(m.sender, tebakkalimat[m.chat][2], balance) 
               ...
               reply(`_Njir betul, ketik .tebakkalimat untuk bermain lagi_`)
         ...
         if (m.quoted.id == siapaaku[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              ...
              await haruka.sendButtonText(m.chat, [{
               ...
               reply(`_Njir betul, ketik .siapaaku untuk bermain lagi_`)               
         ...
         if (m.quoted.id == tekateki[m.chat][0].key.id) {
            ...
            if (m.text.toLowerCase() == jawaban) {
              await addBalance(m.sender, tekateki[m.chat][2], balance) 
               ...
               reply(`_Njir betul, ketik .tekateki untuk bermain lagi_`)               
   ...
   let result = anu[Math.floor(Math.random() * anu.length)]
                    ...
                    setTimeout(() => {
                        if (tebakgambar[m.chat]) {
                            haruka.sendButtonText(m.chat, [{
                                ...
                                type: 1
                            }], waktuHabis(result.jawaban), footxt, m)
                            delete tebakgambar[m.chat]
                        }
                    }, 120000)
                ]
            ...
            case 'tega': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ytega', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ytega': {
                if (!(m.chat in tebakgambar)) return
                clearTimeout(tebakgambar[m.chat][3])
                delete tebakgambar[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebakgambar', 'Soal baru', m)
            }
            break
            case "tebakkata": {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'teka': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.yteka', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'yteka': {
                if (!(m.chat in tebakkata)) return
                clearTimeout(tebakkata[m.chat][3])
                delete tebakkata[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebakkata', 'Soal baru', m)
            }
            break
            case "tebakbendera": {
   ...
   console.log("Jawaban: " + result.name)
                    ...
                    setTimeout(() => {
                        if (tebakbendera[m.chat]) {
                            haruka.sendButtonText(m.chat, [{
                                ...
                                type: 1
                            }], waktuHabis(result.name), footxt, m)
                            delete tebakbendera[m.chat]
                        }
                    }, 120000)
                ]
            ...
            case 'tebe': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.name.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ytebe', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ytebe': {
                if (!(m.chat in tebakbendera)) return
                clearTimeout(tebakbendera[m.chat][3])
                delete tebakbendera[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebakbendera', 'Soal baru', m)
            }
            break
            case 'tebakkalimat': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'tekatu': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ytekatu', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ytekatu': {
                if (!(m.chat in tebakkalimat)) return
                clearTimeout(tebakkalimat[m.chat][3])
                delete tebakkalimat[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebakkalimat', 'Soal baru', m)
            }
            break
            case 'tebaksiapa': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'tesi': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ytesi', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ytesi': {
                if (!(m.chat in siapaaku)) return
                clearTimeout(siapaaku[m.chat][3])
                delete siapaaku[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebaksiapa', 'Soal baru', m)
            }
            break
            case 'tebakkimia': {
   ...
   console.log("Jawaban: " + result.unsur)
                    ...
                    setTimeout(() => {
                        if (tebakkimia[m.chat]) {
                            haruka.sendButtonText(m.chat, [{
                                ...
                                type: 1
                            }], waktuHabis(result.unsur), footxt, m)
                            delete tebakkimia[m.chat]
                        }
                    }, 120000)
                ]
            ...
            case 'teki': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.unsur.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.yteki', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'yteki': {
                if (!(m.chat in tebakkimia)) return
                clearTimeout(tebakkimia[m.chat][3])
                delete tebakkimia[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebakkimia', 'Soal baru', m)
            }
            break
            case 'tebaklirik': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'teli': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.yteli', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'yteli': {
                if (!(m.chat in tebaklirik)) return
                clearTimeout(tebaklirik[m.chat][3])
                delete tebaklirik[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebaklirik', 'Soal baru', m)
            }
            break
            case 'tebaktebakan': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'teteb': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.yteteb', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'yteteb': {
                if (!(m.chat in tebaktebakan)) return
                clearTimeout(tebaktebakan[m.chat][3])
                delete tebaktebakan[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tebaktebakan', 'Soal baru', m)
            }
            break
            case 'susunkata': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'tesuka': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ytesuka', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ytesuka': {
                if (!(m.chat in susunkata)) return
                clearTimeout(susunkata[m.chat][3])
                delete susunkata[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.susunkata', 'Soal baru', m)
            }
            break
            case 'tekateki': {
   ...
   console.log("Jawaban: " + result.jawaban)
            ...
            case 'tete': {
                ...
                haruka.send1ButMes(m.chat, '```' + json.jawaban.replace(/[bcdfghjklmnpqrstvwxyz]/ig, '_') + '```', footxt, '.ttete', 'Dahlah Nyerah Aja✌️', m)
            }
            break
            case 'ttete': {
                if (!(m.chat in tekateki)) return
                clearTimeout(tekateki[m.chat][3])
                delete tekateki[m.chat]
                return haruka.send1ButMes(m.chat, 'Hmm gitu udah nyerah 🥱', footxt, '.tekateki', 'Soal baru', m)
            }
            break
        	//asupan
...
*/
//await haruka.sendMessage(m.chat, buttonMessage, { quoted: m })
await haruka.sendMessage(m.chat, {image: fs.readFileSync(setting.pathimg), caption: allMenu(role, ucapanWaktu, pushname, mundur, upload, download, ownerName, botName, jam, tanggal, runtime, isCreator, isPremium, m.sender, limitCount, limit, gcount, glimit, balance, prefix)}, {quoted: m})
...
let teks = m.quoted ? quoted.text : text
 try {
   try {
                    pic = await haruka.profilePictureUrl(m.sender, 'image')
                } catch {
...
haruka.sendImageAsSticker(m.chat, buffer, m, {
                  packname: setting.botName , author: setting.ownerName
...
*${isLimited ? 'Untuk durasi lebih dari batas disajikan dalam bentuk link' : ''}Link:* ${link}`},{quoted:m})
  ...
  .catch((err) => {
			...
			case 'instagram': case 'ig': case 'igdl': case 'igphoto': case 'instaphoto': case 'instafoto': case 'igfoto': case 'igvideo': case 'instavideo': case 'instavid': case 'igreels': case 'instareels': case 'instareel': case 'igtv': case 'instatv':{
                ...
                await m.reply(mess.wait)
                m.reply("Server maintenance, tunggu update selanjutnya")
              /* let dltik = await fetchJson(`https://tiktok.zeeoneofc.my.id/api/tiktok?url=${args[0]}`)
            if(!dltik.result) return reply("Server sedang eror")
    let data = dltik.result
    if(!data.url){
    for (let i of data) {
    for(let u of i.url){
    haruka.sendFile(m.chat, u.url, 'ig.jpg', "Nih", m)
    //m.reply(util.format(u.url))
    }
    }
    } else {
      haruka.sendFile(m.chat, data.url[0].url, 'ig.mp4', "Nih", m)
    }*/
                }  
                limitAdd(m.sender, limit)
            break            
            ...
            let dltik = await fetchJson(`https://web-tt-zeeoneofficial.cloud.okteto.net/api/tiktok?url=${args[0]}`)
		if(!dltik.result) return m.reply(mess.error.api)
		haruka.sendMessage(m.chat, {video : {url : dltik.result.video.no_watermark}, mimetype:'video/mp4'}, {quoted:m})
}
limitAdd(m.sender, limit)
            break
		...
		let dltik = await fetchJson(`https://web-tt-zeeoneofficial.cloud.okteto.net/api/tiktok?url=${args[0]}`)
		if(!dltik.result) return m.reply(mess.error.api)
		haruka.sendMessage(m.chat, {audio : {url : dltik.result.video.no_watermark}, mimetype:'audio/mpeg'}, {quoted:m})
}
limitAdd(m.sender, limit)
		    break
...
case 'sc':
         case 'source': {
           m.reply("https://youtube.com/playlist?list=PLFCglBzFPHG6ma6nwuT1PORBs9SQl7rlu")
         }
         break
...
`.trim()
  ...
  break
		...
		case'waifu':{
            ...
            case 'translate':
                ...
                args.shift()
                var pepek = args.join(' ')
                var { data } = await axios.get(`https://api.lolhuman.xyz/api/translate/auto/${kode_negara}?apikey=${apikey}&pepek=${text}`)
                ...
                case 'drakorongoing':
                    ...
                    var yaemiko = 'Ongoing Drakor\n\n'
                    for (var x of data.result) {
                        yaemiko += `Title : ${x.title}\n`
                        yaemiko += `Link : ${x.link}\n`
                        yaemiko += `Thumbnail : ${x.thumbnail}\n`
                        yaemiko += `Year : ${x.category}\n`
                        yaemiko += `Total Episode : ${x.total_episode}\n`
                        yaemiko += `Genre : ${x.genre.join(', ')}\n\n`
                    }
                    reply(yaemiko)
                    break
                    case 'cerpen':
                        var { data } = await axios.get(`https://api.lolhuman.xyz/api/cerpen?apikey=${apikey}`)
                        var yaemikoo = `Title : ${data.result.title}\n`
                        yaemikoo += `Creator : ${data.result.creator}\n`
                        yaemikoo += `Story :\n${data.result.cerpen}`
                        reply(yaemikoo)
                        break
                        case 'quotesanime':
                                    ...
                                    case 'jadwalsholat':
                                        ...
                                        break
                                            case 'roboguru':
                                                ...
                                                var guru = 'Beberapa Pembahasan Dari Roboguru :\n\n'
                                                for (var x of data.result) {
                                                    guru += `==============================\n`
                                                    guru += `\`\`\`Pertanyaan :\`\`\`\n${x.question}\n\n`
                                                    guru += `\`\`\`Jawaban :\`\`\`\n${x.answer}\n`
                                                ...
                                                case 'anime':
                                                    ...
                                                    axios.get(`https://api.lolhuman.xyz/api/anime?apikey=${apikey}&query=${full_args}`).then(({ data }) => {
                                                        ...
                                                        haruka.sendMessage(m.chat, { image: { url: data.result.coverImage.large }, caption })
                                                    })
                                                    break
                                                    case 'manga':
                                                        if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
 ...
 /*       case'buylimit':{
            ...
            case 'buylimit': {
                ...
                let currentLimit = getLimit(m.sender, limitCount, limit);
                
                if (currentLimit + parseInt(text) > 25) return m.reply(`Tidak dapat membeli. Pembelian ini akan melebihi limit maksimum 25`);
            
                addCountCmd('#buylimit', m.sender, _cmd);
                kurangBalance(m.sender, ane, balance);
                giveLimit(m.sender, parseInt(text), limit);
                
                // Fetch the updated limit after the purchase
                currentLimit = getLimit(m.sender, limitCount, limit);
            
                reply(`Pembeliaan limit sebanyak ${text} berhasil\n\nSisa Balance : $${getBalance(m.sender, balance)}\nSisa Limit : ${currentLimit}/${limitCount}`);
                }
                break;
/*        case'buygamelimit': case'buyglimit':{
            ...
            case 'buygamelimit':
                case 'buyglimit': {
                    ...
                    let requestedLimit = parseInt(text);
                    if (requestedLimit > 15) return m.reply(`Tidak dapat membeli lebih dari 15 game limit dalam satu kali transaksi`);
                
                    // Get the current game limit
                    let currentGameLimit = cekGLimit(m.sender, gcount, glimit);
                
                    // Check if the purchase exceeds the maximum total limit of 15
                    if (currentGameLimit + requestedLimit > 15) return m.reply(`Tidak dapat membeli. Pembelian ini akan melebihi game limit maksimum 15`);
                
                    let ane = Number(requestedLimit * 50);
                    if (getBalance(m.sender, balance) < ane) return m.reply(`Balance kamu tidak mencukupi untuk pembelian ini`);
                
                    addCountCmd('#buygamelimit', m.sender, _cmd);
                    kurangBalance(m.sender, ane, balance);
                    givegame(m.sender, requestedLimit, glimit);
                
                    reply(`Pembelian game limit sebanyak ${text} berhasil\n\nSisa Balance : $${getBalance(m.sender, balance)}\nSisa Game Limit : ${cekGLimit(m.sender, gcount, glimit)}/${gcount}`);
                    }
                    break;
...
if (!m.isGroup) return m.reply('Fitur Khusus Group!')
    if (!isPetualang) return reply('Kamu belum terdaftar dalam  database rpg silahkan ketik .joinrpg')
    let lastKillTime = cooldowns[m.sender];
    let currentTime = Date.now(); // current time in milliseconds
    let oneDay = 24 * 60 * 60 * 1000;

    if (lastKillTime && (currentTime - lastKillTime < oneDay)) {
        return reply('Anda dapat menggunakannya setelah 24jam ');
    }
...
/*    case 'goblin':
    ...
    case 'goblin':
        case 'killgoblin':{
            ...
            /*if (lastKillTime && (currentTime - lastKillTime < oneHour)) {
                return reply('You can only use this feature once per hour. Please wait a while before trying again.');
            }*/
            if (lastKillTime && (currentTime - lastKillTime < oneHour)) {
            let timeRemaining = ((lastKillTime + oneHour) - currentTime)/60000; //time in minutes
            timeRemaining = Math.ceil(timeRemaining); //rounding up to the nearest minute
            return reply(`You can only use this feature once per hour. Please wait for ${timeRemaining} minutes before trying again.`);
}
    ...
    /*if (lastKillTime && (currentTime - lastKillTime < fiveHours)) {
        return reply('Anda hanya bisa menggunakan Command ini 5 jam sekali');
    }*/
    if (lastKillTime && (currentTime - lastKillTime < fiveHours)) {
        let timeRemaining = ((lastKillTime + fiveHours) - currentTime)/60000; //time in minutes
        timeRemaining = Math.ceil(timeRemaining); //rounding up to the nearest minute
        return reply(`Anda hanya bisa menggunakan Command ini 5 jam sekali. Silahkan tunggu selama ${timeRemaining} menit sebelum mencoba lagi.`);
    }
    ...
    let lastKillTime = cooldowns[m.sender];
    let currentTime = Date.now(); // current time in milliseconds
    let sevenHours = 7 * 60 * 60 * 1000;

    // one hour in milliseconds

    /*if (lastKillTime && (currentTime - lastKillTime < sevenHours)) {
        return reply('Anda hanya bisa menggunakan Command ini 7 jam sekali');
    }*/
    if (lastKillTime && (currentTime - lastKillTime < sevenHours)) {
        let timeRemaining = ((lastKillTime + sevenHours) - currentTime)/60000; //time in minutes
        timeRemaining = Math.ceil(timeRemaining); //rounding up to the nearest minute
        return reply(`Anda hanya bisa menggunakan Command ini 7 jam sekali. Silahkan tunggu selama ${timeRemaining} menit sebelum mencoba lagi.`);
    }
    ...
    let lastKillTime = cooldowns[m.sender];
    let currentTime = Date.now(); // current time in milliseconds
    let tenHours = 10 * 60 * 60 * 1000;


/*    if (lastKillTime && (currentTime - lastKillTime < tenHours)) {
        return reply('Anda hanya bisa menggunakan Command ini 10 jam sekali');
    }*/
    if (lastKillTime && (currentTime - lastKillTime < tenHours)) {
        let timeRemaining = ((lastKillTime + tenHours) - currentTime)/60000; //time in minutes
        timeRemaining = Math.ceil(timeRemaining); //rounding up to the nearest minute
        return reply(`Anda hanya bisa menggunakan Command ini 10 jam sekali. Silahkan tunggu selama ${timeRemaining} menit sebelum mencoba lagi.`);
    }
